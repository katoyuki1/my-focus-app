...
import { QuotesScreen } from "./components/QuotesScreen"; // Quotesタブで使う
import { SettingsScreen } from "./components/SettingsScreen"; // 設定画面
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen name="Quotes" component={QuotesScreen} options={{ title: "名言リスト" }} />
